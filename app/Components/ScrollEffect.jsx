...
const Skiper19 = () => {
    ...
    const opacity = useTransform(scrollYProgress, [0, 1], [4, 0]); // Fades out as you scroll down
    const y = useTransform(scrollYProgress, [0, 1], [0, 100]); // Moves down by 200 pixels

    return (
        <section
            ref={ref}
            className="mx-auto flex h-[350vh] flex-col items-center overflow-hidden bg-[#FAF9F6] px-4 text-[#1F3A4B]"
        >
            <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
                ...
                <LinePath
                    className="absolute -right-[35rem] top-0 z-0"
            ...
            <motion.div
                ...
                className="rounded-4xl font-jakarta-sans w-full translate-y-[200vh] bg-[#1F3A4B] pb-10 text-orange-500">
                <h1 className="mt-10 text-center text-[15.4vw] font-bold leading-[0.9] tracking-tighter lg:text-[14.5vw]">
                    dsrathore.com
                </h1>
                <div className="mt-80 flex w-full flex-col items-start gap-5 px-4 font-medium lg:mt-0 lg:flex-row lg:justify-between">
                    <div className="flex w-full items-center justify-between gap-12 uppercase lg:w-fit lg:justify-center">
                        ...
                        <p className="w-fit text-right text-sm lg:text-left">
                            {monthName} {date}, {year}  <br /> the gujju land
                        </p>
                    </div>
                    <div className="flex w-full flex-wrap items-center justify-between gap-12 uppercase lg:w-fit lg:justify-center">
                        ...
                        <p className="w-fit text-right text-white text-sm lg:text-left">
                            in person tickets <br /> ₹499
                        </p>
                    </div>
                </div>
            </motion.div>
