        ...
        <>
            ...
            <div className='relative h-screen w-full'>
                <motion.div
                    ...
                    transition={{ duration: 0.6 }} className='w-[25rem] h-[30rem] absolute right-[13rem] top-[10rem]'>
                ...
                <div>
                    ...
                    <div className='absolute left-[13rem] top-[19rem]'>
                        ...
                        <p className='text-[17px] text-gray-500 font-sans font-extralight'>DevOps Cloud Engineer / MLOps Player / Freelancer / Photographer</p>
                    </div>
