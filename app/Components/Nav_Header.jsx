...
const Nav_Header = () => {
    return (
        <div className='flex text-gray-700 bg-[#faf9f4] justify-between text-[.9rem] items-center border-b-[.05rem] border-gray-200 shadow-xs h-[4rem] w-screen absolute z-[1]'>
            <div className='ml-10'>
            ...
            <div>
                <ul className='list-none font-mono font-light duration-300 ease-in-out tracking-widest flex gap-[3.4rem] mr-[10rem] justify-center items-center'>
                    ...
                    <li className='hover:text-black hover:font-bold duration-200 ease-in-out cursor-pointer'><Link href="/Pages/photography">Photography</Link></li>
